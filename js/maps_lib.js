...
var MapsLib = {
  ...
  fusionTableId:      "1Cvo3sKid3I1wBsqmyF85J9enDTuodoG6g_bjg27Q", //Moormeldingen data layer
  
  polygon1TableID:    "1PC-IVFW03vAx_4glEBfZYHz8TcqqiNWXvx3QFa66", // Oudstedelijke gebieden
  polygon2TableID:    "17TcDCEIBtdXf2DQhyndkPHIGMX-WJ3GWLXLN61BR", //Bodemkwaliteitskaart
  ...
  //-----custom filters for point data layer
    ...
    var tempWhereClause = [];
    if ( $("#cbType1").is(':checked')) tempWhereClause.push("klein");
    if ( $("#cbType2").is(':checked')) tempWhereClause.push("Groot");
    if ( $("#cbType3").is(':checked')) tempWhereClause.push("Calamiteit");
  ...
  getList: function(whereClause) {
    ...
    var selectColumns = "Status, netbeheerder, Type_werk2, Type_Werk, Beheerder_Openbare_Ruimte, Aannemernetbeheerder, Address";
